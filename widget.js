<div id="kinetico-widget-lux-score">
  <style>
    ...
    .kw-suggestions { 
        position: absolute; top: 65px; left: 30px; right: 30px; 
        background: white; border: 1px solid #cce4f7; 
    ...
    .kw-slider-bar { 
        ...
        background: linear-gradient(90deg, var(--k-orange) 0%, var(--k-magenta) 50%, var(--k-cyan) 100%); 
  ...
  <div class="kw-search-area">
    ...
    <div id="kw-loader-lux" class="kw-loader">Chargement des données Luxembourg...</div>
  ...
  <script type="3da4fa37b0516ee41cff9377-text/javascript">
    (function() {
      ...
      // 1. CHARGEMENT DONNÉES AU DÉMARRAGE
      ...
      // 3. LOGIQUE D'AFFICHAGE (VDL vs RESTE)
